...
st.write(
    ":dog: Upload an image to watch the background magically get removed. Full quality images can be downloaded from the sidebar. Yay to the [rembg library](<https://github.com/danielgatis/rembg>) :grin:"
)
